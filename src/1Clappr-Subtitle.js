define(["require", "exports", "Clappr"], function (require, exports, Clappr) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BLOCK_REGEX = /[0-9]+(?:\r\n|\r|\n)([0-9]{2}:[0-9]{2}:[0-9]{2}(?:,|\.)[0-9]{3}) --> ([0-9]{2}:[0-9]{2}:[0-9]{2}(?:,|\.)[0-9]{3})(?:\r\n|\r|\n)((?:.*(?:\r\n|\r|\n))*?)(?:\r\n|\r|\n)/g;
    debugger;
    class ClapprSubtitleClass {
        /**
         * @constructor
         */
        constructor() {
    ...
    exports.ClapprSubtitleClass = ClapprSubtitleClass;
    debugger;
    exports.ClapprSubtitle = Clappr.CorePlugin.extend(ClapprSubtitleClass);
});
